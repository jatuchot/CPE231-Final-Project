...
<div class="card-header bg-light">
	...
	<form action="{{ url('grade/gradeassign/validation') }}" method="post" enctype="multipart/form-data" files=true>
        <br>
        <div class="col-sm-12">
	...
	<div class="col-sm-12">
        <div class="form-group"><hr>
            ...
            <input type="text" class="form-control" name="table_name" id="table_name" placeholder="table_name" value="grade_results">
        </div>
